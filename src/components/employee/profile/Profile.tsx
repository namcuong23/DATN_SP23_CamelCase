...
const Profile: any = () => {
    ...
    const { data: post } = useGetUserByEmailQuery(id as string)
    ...
    //     }
    // }
    // const handleUpdate: SubmitHandler<any> = async (userEprForm: any) => {
    //     const update: any = await updateUser({
    //       ...userEprForm,
    //       _id: user._id,
    //       isEmailVerified: user.isEmailVerified,
                                                    ...
                                                    <div className='py-3'>
                                                        <div className='flex items-center gap-x-2 mx-3'>
                                                            <div className='w-50 flex flex-col'>
                                                                ...
                                                                <select  {...register('province')} name='province' defaultValue={0} onChange={changeSelect} className='w-full border-1 border-[#D9D9D9] rounded focus:outline-none focus:border-[#005AFF] px-1 h-9'>
                                                            ...
                                                            <div className='w-50 flex flex-col'>
                                                                ...
                                                                <select {...register('district')} defaultValue={0} name='district' className='w-full border-1 border-[#D9D9D9] rounded focus:outline-none focus:border-[#005AFF] px-1 h-9'>
                                                    ...
                                                    <div className='py-3'>
                                                        <div className='mx-3'>
                                                            <div className='flex flex-col'>
                                                                ...
                                                                <input className='w-full border-1 border-[#D9D9D9] rounded focus:outline-none focus:border-[#005AFF] px-1 h-9'
                                                                    {...register('specific_address')} name='specific_address' />
                                                            </div>
                                                        </div>
                                                    </div>
