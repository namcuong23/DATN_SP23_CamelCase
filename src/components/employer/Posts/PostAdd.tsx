  ...
  return (
    <>
      <div className="mt-4 w-100">
        <h1 className="mb-3 text-center text-3xl font-bold text-[#44454A]">
          Đăng tin
        </h1>
        <Form onFinish={onHandleAdd} form={form} name="add" layout="vertical">
              ...
              <div className="w-100 ms-3">
                ...
                <Form.Item
                  ...
                  rules={[
                    ...
                    {
                      min: 10,
                      message: "This field is must be at least 10 characters.",
                    },
                  ]}
                >
                  <Input.TextArea
                ...
                <Form.Item
                  ...
                  rules={[
                    { required: true, message: "Please choose working form." },
                  ]}
                >
                ...
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Please input number of recruits.",
                    },
                ...
                <Form.Item name="typeOfWork" label="Loại hình">
                  {/* <Input /> */}
                  <Select defaultValue={typeOfWork[0]}>
                    {typeOfWork.map((item: any) => (
                      <Select.Option value={item}>
                        {item}
                      </Select.Option>
                    ))}
                ...
                <Form.Item
                  ...
                  label="Khu vực"
                  rules={[
                    { required: true, message: "Please input work location." },
                  ]}
                >
                  {/* <Input /> */}
          ...
          <div className="text-center sticky bottom-0 bg-white border-t-2 py-3">
            <button
              className="bg-[#FE7D55] hover:bg-[#FD6333] text-white text-[16px] py-1 px-6 rounded"
              type="submit"
            >
              Đăng
            </button>
