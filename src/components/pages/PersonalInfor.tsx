                        ...
                        <div className='flex items-start w-100 gap-3 p-3'>
                            <aside className='rounded w-25 space-y-2'>
                                <section className='border-1 rounded bg-[#4A80F8] p-3'>
                                    <div className='flex items-center space-x-4'>
                                        ...
                                        <div>
                                            <h3 className='text-[20px] font-[600] text-white'>a</h3>
                                        </div>
                                    </div>
                                </section>
                            ...
                            <div className="w-75">
                                ...
                                <div className='myJob border bg-white pl-5 pt-3 rounded my-3'>
                                    <div className='row'>
                                        <img width="120" height="120" src="https://images.vietnamworks.com/images/linkedin/icon-linkedin.svg" alt="Icon linkedin" className='col-2' />
                                        <div className='col-10'>
                                            <h3 className='font-bold text-lg'>Tiết kiệm thời gian bằng cách nhập hồ sơ LinkedIn hiện có của bạn!</h3>
                                            <p className='my-3'>Thông tin hồ sơ PT sẽ được thay thế bằng thông tin từ tài khoản LinkedIn của bạn. Ví dụ: kỹ năng, học vấn, kinh nghiệm,… và bạn không thể hoàn tác.</p>
                                            <a href="https://www.linkedin.com/" className='bg-[#005aff] py-2 rounded'>
                                                <label className='text-white font-bold px-4 py-2'>Nhập hồ sơ</label>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div className='myJob border bg-white pl-5 pt-3 rounded my-3'>
                                    <div className='row'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" className="ProfilePicture_userPlaceholder__YbFoJ col-2 bg-gray-200 rounded" viewBox="0 0 30 30"><path d="M15 3a6 6 0 00-6 6v1a6 6 0 1012 0V9a6 6 0 00-6-6zm-.002 16c-4.006 0-9.146 2.167-10.625 4.09C3.459 24.279 4.329 26 5.828 26H24.17c1.499 0 2.369-1.721 1.455-2.91C24.146 21.168 19.004 19 14.998 19z"></path></svg>
                                        <div className='col-10 px-5'>
                                            <h1 className='font-bold text-2xl pb-3'>Vũ Thanh Bình</h1>
                                            <div>
                                                <div>
                                                    <label className='text-gray-500'>Chức danh:</label> <label className='font-bold'>Nhân viên</label>
                                                </div>
                                                <div>
                                                    <label className='text-gray-500'>Cấp bậc hiện tại:</label> <label className='font-bold'>Thực tập sinh/Sinh viên</label>
                                                </div>
                                                <div>
                                                    <label className='text-gray-500'>Năm Kinh Nghiệm:</label> <label className='font-bold'>1 năm kinh nghiệm</label>
                                                </div>
                                                <div>
                                ...
                                {hidden ?
                                    ...
                                    <div className='myJob border bg-white pl-5 pt-3 rounded my-3'>
                                        <div className='row'>
                                            <h1 className='font-bold text-2xl pb-3 col-10'>Thông tin cá nhân</h1>
                                        </div>
                                        <form onSubmit={handleSubmit(onSubmit)} className='mt-4'>
                                            <div className='row mt-3'>
                                                <div className="mb-3 col-6" >
                                                    <label className="form-label"> <label className="text-red-400">*</label> Email</label>
                                                    <input type="text" className="form-control" {...register("email", { required: true, pattern: /^[A-Za-z0-9]+[A-Za-z0-9]+@[A-Za-z0-9]+(\.[A-Za-z0-9]+)$/, })} />
                                            ...
                                            <div className='row mt-3'>
                                                <div className="mb-3 col-6">
                                                    <label className="form-label"><label className="text-red-400">*</label> Giới tính</label>
                                                    <div>
                                                        <input type="radio" id="male" value="M" name='sex' className='mr-3' /> Nam
                                                        <input type="radio" id="female" value="F" name='sex' className='ml-5 mr-3' />Nữ
                                                    </div>
                                                </div>
                                                <div className="mb-3 col-6">
                                            ...
                                            <div className='row mt-3'>
                                                ...
                                                <div className="mb-3 col-6">
                                                    ...
                                                    {errors.district?.type === "required" && <p className='text-danger'>Vui lòng nhập Quận/Huyện</p>}
                                                </div>
                                            </div>
                                            <div className='row mt-3'>
                                                <div className="mb-3 col-6">
                                            ...
                                            <div className='row'>
                                                <div className='col mt-4 mx-2'>
                                                    <label className='text-red-400'>*</label> <label>Thông tin bắt buộc</label>
                                                </div>
                                                <div className='col'>
                                                    <button className="btn btn-primary my-3 ">Lưu</button>
                                                    <a onClick={hideForm} className='mx-4 border rounded py-2 px-2 hover:font-bold'>Hủy</a>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            {/* <div className="col-3">
                                ...
                                <div className='myJob  bg-white pl-5 py-3 rounded-bottom border border-info border-opacity-10'>
                                    <div className='row border-bottom'>
                                        <img src="image.png" alt="" className='col-2' />
                                        <div className='col-10'>
                                            <h3>Application Engineer</h3>
                                            <p>Cai Lan International Container Terminal (Cict)</p>
                                            <p className='text-red-300'>$700-$1000</p>
                                        </div>
                                    </div>
                                    <div className='row border-bottom'>
                                        <img src="image.png" alt="" className='col-2' />
